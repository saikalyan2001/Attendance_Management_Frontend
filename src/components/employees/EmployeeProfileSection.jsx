...
import { Loader2, Edit, User, Copy, ChevronDown, ChevronUp } from 'lucide-react';
...
const EmployeeProfileSection = ({ employee, canEdit = false, title = "Profile", onEditClick, settings  }) => {
  ...
  const totalYearlyPaidLeaves = useMemo(() => {
    ...
    const paidLeavesPerYear = settings?.paidLeavesPerYear || 12;
      ...
      >
        <CardHeader className="flex flex-row flex-wrap items-center justify-between px-2 xs:px-3 sm:px-6 py-2 xs:py-3 sm:py-6 gap-1 xs:gap-2">
          <CardTitle id="employee-profile-title" className="text-2xs xs:text-base sm:text-2xl md:text-3xl font-bold flex items-center gap-1 xs:gap-2 sm:gap-3 truncate">
            ...
            <span className="truncate">{employee.name}'s {title}</span>
          </CardTitle>
          {canEdit && (
            <Button
              variant="outline"
                    ...
                    <div className="flex items-center mt-0.5 xs:mt-1 sm:mt-2 group">
                      ...
                      {employee.bankDetails.accountNo && (
                        <TooltipProvider delayDuration={200}>
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <CopyButton text={employee.bankDetails.accountNo} fieldId="accountNo" />
                            </TooltipTrigger>
                            <TooltipContent className="bg-complementary text-body border-accent text-2xs xs:text-xs sm:text-base max-w-[75vw] xs:max-w-[85vw] sm:max-w-none z-[100]" side="top">
                              Copy account number
                            </TooltipContent>
                    ...
                    <div className="flex items-center mt-0.5 xs:mt-1 sm:mt-2 group">
                      ...
                      {employee.bankDetails.ifscCode && (
                        <TooltipProvider delayDuration={200}>
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <CopyButton text={employee.bankDetails.ifscCode} fieldId="ifscCode" />
                            </TooltipTrigger>
                            <TooltipContent className="bg-complementary text-body border-accent text-2xs xs:text-xs sm:text-base max-w-[75vw] xs:max-w-[85vw] sm:max-w-none z-[100]" side="top">
                              Copy IFSC code
                            </TooltipContent>
                    ...
                    <div className="flex items-center mt-0.5 xs:mt-1 sm:mt-2 group">
                      ...
                      {employee.bankDetails.bankName && (
                        <TooltipProvider delayDuration={200}>
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <CopyButton text={employee.bankDetails.bankName} fieldId="bankName" />
                            </TooltipTrigger>
                            <TooltipContent className="bg-complementary text-body border-accent text-2xs xs:text-xs sm:text-base max-w-[75vw] xs:max-w-[85vw] sm:max-w-none z-[100]" side="top">
                              Copy bank name
                            </TooltipContent>
                    ...
                    <div className="flex items-center mt-0.5 xs:mt-1 sm:mt-2 group">
                      ...
                      {employee.bankDetails.accountHolder && (
                        <TooltipProvider delayDuration={200}>
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <CopyButton text={employee.bankDetails.accountHolder} fieldId="accountHolder" />
                            </TooltipTrigger>
                            <TooltipContent className="bg-complementary text-body border-accent text-2xs xs:text-xs sm:text-base max-w-[75vw] xs:max-w-[85vw] sm:max-w-none z-[100]" side="top">
                              Copy account holder
                            </TooltipContent>
            ...
            <CollapsibleContent className="mt-1 xs:mt-1.5 sm:mt-4 animate-fade-in">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 xs:gap-4 sm:gap-6">
                ...
                <div>
                  ...
                  <p className="text-body mt-0.5 xs:mt-1 sm:mt-2 text-xs xs:text-sm sm:text-base md:text-lg">{employee.paidLeaves?.available || 0}</p>
                </div>
                <div>
                  <Label className="text-2xs xs:text-xs sm:text-sm md:text-base font-semibold text-body">Used</Label>
                  <p className="text-body mt-0.5 xs:mt-1 sm:mt-2 text-xs xs:text-sm sm:text-base md:text-lg">{employee.paidLeaves?.used || 0}</p>
                </div>
                <div>
                  <Label className="text-2xs xs:text-xs sm:text-sm md:text-base font-semibold text-body">Carried Forward</Label>
                  <p className="text-body mt-0.5 xs:mt-1 sm:mt-2 text-xs xs:text-sm sm:text-base md:text-lg">{employee.paidLeaves?.carriedForward || 0}</p>
                </div>
              </div>
            </CollapsibleContent>
          </Collapsible>
