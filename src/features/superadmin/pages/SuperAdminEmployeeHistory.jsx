...
import { getEmployeeHistory, reset as resetEmployees } from '../redux/superadminEmployeeSlice';
...
const SuperAdminEmployeeHistory = () => {
  const { employeeId } = useParams(); // Get employeeId from URL
  const dispatch = useDispatch();
  const navigate = useNavigate();
  const { employees, history, loading: employeesLoading, error: employeesError } = useSelector((state) => state.superadminEmployees);
...
export default SuperAdminEmployeeHistory;
