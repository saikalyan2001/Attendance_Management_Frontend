...
const SuperAdminEmployeeProfileSection = ({ currentEmployee, isHighlighted, totalYearlyPaidLeaves, openEditDialog }) => {
...
export default SuperAdminEmployeeProfileSection;