...
const SuperAdminMonthlyAttendance = ({ month, year, location, setLocation, setMonth, setYear }) => {
  ...
  useEffect(() => {
    if (error) {
      ...
      dispatch({ type: "superAdminAttendance/reset" });
    }
  }, [error, dispatch]);
  ...
  const handleDownloadExcel = () => {
    if (!monthlyAttendance || !monthlyAttendance.length) {
      toast.error("No attendance data available to export. Please ensure data is loaded.", { duration: 5000 });
      return;
    }
    setIsExporting(true);
    const monthlyTotals = {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Button
                ...
                disabled={!dateFilter || locationsLoading}
            ...
            <div className="space-y-2">
              ...
              <Button
                ...
                className="w-full bg-accent text-body hover:bg-accent-hover text-sm py-2 px-4 flex items-center gap-2 h-10 rounded-md focus:outline-none focus:ring-2 focus:ring-accent"
                disabled={isExporting || loading || empLoading || locationsLoading || !attendanceEmployees.length || !monthlyAttendance?.length}
