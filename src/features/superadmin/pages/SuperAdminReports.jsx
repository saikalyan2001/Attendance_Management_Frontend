...
import AttendanceTable from "./SuperAdminAttendanceTable";
import LeaveTable from "./SuperAdminLeaveTable";
import SalaryTable from "./SuperAdminSalaryTable";
...
const SuperAdminReports = () => {
  ...
  return (
    <Layout title="Superadmin Reports">
